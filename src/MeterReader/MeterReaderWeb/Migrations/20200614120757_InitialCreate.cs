    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2020, 6, 14, 14, 7, 57, 141, DateTimeKind.Local).AddTicks(3880), 1458.9000000000001 });

            migrationBuilder.InsertData(
                table: "Readings",
                columns: new[] { "Id", "CustomerId", "ReadingDate", "Value" },
                values: new object[] { 2, 1, new DateTime(2020, 6, 14, 14, 7, 57, 151, DateTimeKind.Local).AddTicks(7850), 18403.5 });

            migrationBuilder.InsertData(
                table: "Readings",
                columns: new[] { "Id", "CustomerId", "ReadingDate", "Value" },
                values: new object[] { 3, 2, new DateTime(2020, 6, 14, 14, 7, 57, 151, DateTimeKind.Local).AddTicks(7910), 0.0 });

            migrationBuilder.InsertData(
                table: "Readings",
                columns: new[] { "Id", "CustomerId", "ReadingDate", "Value" },
                values: new object[] { 4, 2, new DateTime(2020, 6, 14, 14, 7, 57, 151, DateTimeKind.Local).AddTicks(7920), 304.75 });
